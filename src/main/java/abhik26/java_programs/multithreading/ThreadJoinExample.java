...
public class ThreadJoinExample {
	...
	public static void main(String[] args) throws InterruptedException {
		Runnable r = () -> {
			...
			System.out.println(
					String.format("Thread with name: '%s' has come out of sleep.", Thread.currentThread().getName()));
		};

		Thread t = new Thread(r, "Child Thread");

		t.start();
		// always do thread join after the start method is invoked, other-wise it will
		// not work.
		// t.join();
		t.join(1000);
